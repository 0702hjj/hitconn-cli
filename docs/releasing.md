...
```console
scripts/create-manifest-payload.sh 0.2.0 \
  https://github.com/YinMo19/hitconn-cli/releases/download/v0.2.0 \
...
```json
{"schemaVersion":1,"channel":"stable","version":"0.2.0","protocolMin":1,"protocolMax":1,"artifacts":[{"target":"x86_64-unknown-linux-gnu","url":"https://example/hitconn-x86_64-unknown-linux-gnu","size":123,"sha256":"..."}]}
```
